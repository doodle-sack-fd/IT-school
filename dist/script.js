...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var miniSliderShowUp = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var miniModulesSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var miniFeedSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  _createClass(Forms, [{
    ...
    value: function initMask() {
      ...
      function createMask(evt) {
        ...
        /* Получаем / *удаляем* все НЕ цифры и замещаем пустой строкой   */
        val = this.value.replace(/\D/g, '');
        /* Динамичное, ввел пользователь */
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "bindTriggers",
    value: function bindTriggers(moluleBtn, direction) {
      var _this2 = this;
      ...
      document.querySelectorAll(moluleBtn).forEach(function (btn) {
